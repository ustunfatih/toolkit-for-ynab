...
/* harmony export */ });
/* harmony import */ var core_js_modules_es7_array_includes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
/* harmony import */ var toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35);
...
function getBrowserName() {
  ...
  if (URL.startsWith(toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.BrowserExtensionPrefix[toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Chrome])) {
    return toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Chrome;
  }
  if (URL.startsWith(toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.BrowserExtensionPrefix[toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Firefox])) {
    return toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Firefox;
  }
  if (URL.startsWith(toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.BrowserExtensionPrefix[toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Edge])) {
    return toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Edge;
  }
  if (URL.startsWith(toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.BrowserExtensionPrefix[toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Browser.Safari])) {
...
function getEnvironment() {
  ...
  const environment = toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.ExtensionIdEnvironmentMap[extensionId];
  return environment || toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_1__.Environment.Development;
}
...
/* harmony export */   ExtensionIdEnvironmentMap: () => (/* binding */ ExtensionIdEnvironmentMap),
...
/* harmony export */ });
/* harmony import */ var toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
class ToolkitStorage {
    constructor(storageArea = StorageArea.Local) {
        this.browser = (0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)();
    ...
    offStorageItemChanged(storageKey, callback) {
        if (this.storageListeners.has(storageKey)) {
            const listeners = this.storageListeners.get(storageKey);
            this.storageListeners.set(storageKey, listeners.filter((listener) => listener !== callback));
        }
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   allToolkitSettings: () => (/* reexport safe */ _settings__WEBPACK_IMPORTED_MODULE_0__.allToolkitSettings),
/* harmony export */   getUserSettings: () => (/* binding */ getUserSettings),
/* harmony export */   settingMigrationMap: () => (/* reexport safe */ _settings__WEBPACK_IMPORTED_MODULE_0__.settingMigrationMap),
/* harmony export */   settingsMap: () => (/* reexport safe */ _settings__WEBPACK_IMPORTED_MODULE_0__.settingsMap)
/* harmony export */ });
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50);
/* harmony import */ var toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36);
...
function getUserSettings() {
    return storage.getStoredFeatureSettings().then((storedFeatureSettings) => {
        const settingPromises = _settings__WEBPACK_IMPORTED_MODULE_0__.allToolkitSettings.map((setting) => {
            ...
            const migrationSetting = _settings__WEBPACK_IMPORTED_MODULE_0__.settingMigrationMap[setting.name];
            if (migrationSetting &&
        ...
        return Promise.all(settingPromises).then((persistedSettings) => {
            const userSettings = _settings__WEBPACK_IMPORTED_MODULE_0__.allToolkitSettings.reduce((allSettings, currentSetting, index) => {
...
const settingsMap = {
    ...
    "BottomNotificationBar": {
        ...
        "description": "Move the notification bar to the bottom as an overlay preventing transactions from \"jumping around.\""
    },
    "BulkEditDate": {
        "name": "BulkEditDate",
        "type": "checkbox",
        ...
        "description": "Add an option to the \"Edit Transaction(s)\" menu to \"Edit Date(s)\" for all selected transactions."
    },
    "BulkEditMemo": {
        "name": "BulkEditMemo",
        "type": "checkbox",
        ...
        "description": "Add an option to the \"Edit Transaction(s)\" menu to \"Edit Memo(s)\" for all selected transactions. Allows adding a prefix or a suffix to selected memos."
    },
    "BulkManagePayees": {
        ...
        "description": "Add an option to the \"Edit Transaction(s)\" menu to \"Manage Payee(s)\" for all selected transactions."
    },
    "CalculateIRR": {
        "name": "CalculateIRR",
        "type": "select",
        ...
        "description": "Calculate Internal Rate of Return for Tracking Accounts. Set Tracking Account contributions to this color to calculate IRR",
        "options": [
            {
                "name": "Red",
                "value": "Red"
    ...
    "CalendarFirstDay": {
        ...
        "description": "Adjust the first day of the week in the calendar to whichever day you chose when editing or adding a transaction.",
        "options": [
            {
                "name": "Monday",
                "value": "1"
    ...
    "ChangeEnterBehavior": {
        ...
        "description": "Change the default action of pressing \"Enter\" to save a transaction rather than \"Save and add another\"."
    },
    ...
    "CompactAccountHeader": {
        ...
        "description": "Compact the account header. Something reminescent of the old-style account headers."
    },
    ...
    "DefaultCCToCleared": {
        ...
        "description": "Change the default credit card payment value to use the Cleared Balance instead of the Working Balance to avoid overpaying credit card bills. *__Note__: If you don't have enough budgeted in Payment to cover the selected option, it will use the Payment value instead to avoid overbudgeting*"
    },
    ...
    "LargerClickableIcons": {
        ...
        "description": "Makes the uncleared, cleared and reconciled icons slightly larger and easier to click."
    },
    "LinkInMemo": {
        "name": "LinkInMemo",
        "type": "checkbox",
    ...
    "MemoAsMarkdown": {
        ...
        "description": "Enables Markdown parsing for memos, allowing support for links and other formatting. Learn how to use Markdown [here](https://www.markdownguide.org/cheat-sheet)."
    },
    "ReconcileAssistant": {
        ...
        "description": "Provides a tool to help find uncleared transactions which add up to the provided reconciliation amount during the normal reconciliation flow."
    },
    "ReconcileBalance": {
        ...
        "description": "Show the current reconciled balance excluding cleared and non-reconciled transactions"
    },
    "ReconcileConfetti": {
        ...
        "description": "Add a fun confetti animation when marking an account as reconciled to mark your tremendous achievement."
    },
    "ReconciledTextColor": {
        ...
        "description": "Add emphasis to reconciled transaction rows to better distinguish them from \"active\" transactions.",
        "options": [
            {
                "name": "Green",
                "value": "1"
    ...
    "RowHeight": {
        ...
        "description": "Make the height of transaction rows smaller allowing more transactions to fit on the screen.",
        "options": [
            {
                "name": "Compact",
                "value": "1"
    ...
    "ShowCategoryBalance": {
        ...
        "description": "Add a tooltip showing the total available balance for a transaction's category after breifly hovering the transaction category."
    },
    "SplitTransactionAutoAdjust": {
        ...
        "description": "Automatically fill each additional split transaction row with the current remaining amount."
    },
    "SplitTransactionAutoFillPayee": {
        ...
        "description": "Automatically fill the split transaction payee value, if empty, with the original payee."
    },
    ...
    "ToggleSplits": {
        ...
        "description": "Add a button to expand/collapse all splits for the current account register."
    },
    "ToggleTransactionFilters": {
        ...
        "description": "Add buttons to quickly show/hide either scheduled or reconciled transactions with one click.",
        "options": [
            {
                "name": "Show Icons",
                "value": "1"
    ...
    "CheckCreditBalances": {
        ...
        "description": "Highlights credit card category balances with a yellow warning and adds an alert icon next to the account if the balance of the category does not match the account balance. Adds a button to the Inspector to rectify the difference."
    },
    "CollapseInspector": {
    ...
    "MasterCategoryRowColorSelect": {
        ...
        "description": "The color which will be used for the Default and Classic YNAB Themes. The default is #d1d1d6."
    },
    ...
    "DaysOfBufferingExcludeCreditCards": {
        ...
        "description": "Option to exclude credit cards from the days of buffering calculation, this will usually eliminate negative calculations for Days of Buffering but it should be noted that this will also inflate you \"Days of Buffering\" as far as the actual calculation goes."
    },
    ...
    "DisplayTotalMonthlyGoals": {
        ...
        "description": "Add a 'Total Monthly Targets' section to the budget inspector, which displays the total amount of monthly funding targets. It's also possible to have a more detailed overview of the targets, and information of 'Income vs Spending' for the month.",
        "options": [
            {
    ...
    "DisplayTotalOverspent": {
        ...
        "description": "Adds \"Overspending\" to the budget inspector, which displays the total overspending from selected categories."
    },
    ...
    "FundHalf": {
        ...
        "section": "budget",
        "title": "Add Fund Half",
        "description": "Adds a button or buttons to fund half of your category's monthly Target amount.  Perfect for budget categories you fund half of twice a month.  Low Half/High Half refers to which you assign when the monthly Target amount is an odd number.  Works with multiple selected budget categories."
    },
    "GoalIndicator": {
        "name": "GoalIndicator",
        "type": "checkbox",
        ...
        "description": "Add an indicator to subcategories with targets. Types: (M)onthly Savings Builder, Savings Balance By (D)ate, Savings (B)alance, Needed For (S)pending, (M)onthly (D)ebt Payment, and (U)pcoming transactions."
    },
    "GoalWarningColor": {
        ...
        "description": "Change the default orange target underfunded warning to blue to better differentiate it from credit card overspending."
    },
    "HideAgeOfMoney": {
        "name": "HideAgeOfMoney",
        "type": "checkbox",
        ...
        "description": "Hides \"Age of Money\" in the budget header. YNAB will continue to run its Age of Money calculations, so the data will always be up to date if you decide to show it again."
    },
    "HoveredBudgetRows": {
    ...
    "CurrentMonthIndicator": {
        ...
        "description": "Change the month background color to better distinguish you're looking at the current month."
    },
    "HighlightNegatives": {
    ...
    "LiveOnLastMonthsIncome": {
        ...
        "description": "Add a section to the budget inspector showing your variance between last month's income and this month's assigned budget for users who still live by the old Rule #4.",
        "options": [
            {
    ...
    "QuickBudgetWarning": {
        ...
        "description": "Pop up a confirmation prompt when using a quick budget option to prevent mistakingly altering your budget."
    },
    ...
    "RowsHeight": {
        ...
        "description": "Make the height of budget category rows smaller allowing more categories to fit on the screen.",
        "options": [
            {
                "name": "Compact",
                "value": "1"
    ...
    "ShowAvailableAfterSavings": {
        ...
        "description": "Shows \"Available After Savings\" in the budget breakdown. This allows you to see how much you have available if you exclude your savings. Any categories under a category group that includes \"Savings\" in its name will be taken into account. You can also add \"Savings\" anywhere in the name of a category to mark it."
    },
    "StripedBudgetRows": {
    ...
    "ToggleMasterCategories": {
        ...
        "description": "Add a toggle to the budget table header to expand/collapse all categories at once. You can also enable \"Solo Mode\" by right clicking the toggle which will ensure only one category is expanded at a time."
    },
    "AccountsDisplayDensity": {
        ...
        "description": "Make the account names and their padding in the sidebar smaller allowing more accounts to fit on the screen.",
        "options": [
            {
                "name": "Compact",
                "value": "1"
    ...
    "CategoryActivityCopy": {
        ...
        "description": "Add a button to copy transactions displayed in the various Activity Modals (Budget and Reports pages)."
    },
    "CustomizeColourScheme": {
        ...
        "description": "Add an option in YNAB's Display Menu to customize the default green/orange/red color scheme to whatever you wish."
    },
    "EditAccountButton": {
        ...
        "description": "Hide the \"Edit Account\" icon on account rows in the sidebar to avoid misclicks. You can still edit an account by right-clicking the account name."
    },
    "EmphasizeNegativeLoans": {
        ...
        "description": "Emphasize loans with negative balances similar to how other negative accounts are emphasized."
    },
    "GoogleFontsSelector": {
    ...
    "HideClosedAccounts": {
        ...
        "description": "Hide closed accounts from the sidebar. They can then be toggled using the button added to the User Menu (click your e-mail)."
    },
    "HideHelp": {
        "name": "HideHelp",
        "type": "checkbox",
        ...
        "description": "Hide the blue help (?) button in the bottom right corner of the screen. The button can then be toggled using the button added to the User Menu (click your e-mail)."
    },
    "HideReferralBanner": {
    ...
    "ImportNotification": {
        ...
        "description": "Adds an underline to account names in the sidebar that have transactions to be imported. Hovering over the account name will display the number of transactions waiting to be imported.",
        "options": [
            {
    ...
    "NavDisplayDensity": {
        ...
        "description": "Make the navigation tab names (Budget, Reports, etc) and their padding smaller allowing more content to fit on the screen.",
        "options": [
            {
                "name": "Compact",
                "value": "1"
    ...
    "PrivacyMode": {
        ...
        "section": "general",
        "title": "Privacy Mode",
        "description": "Obscure dollar amounts everywhere until hovered. In toggle mode, a lock icon will appear in the lower left corner of YNAB. Click to enable or disable privacy mode.",
        "options": [
            {
                "name": "Always On",
                "value": "1"
    ...
    "SquareNegativeMode": {
        ...
        "description": "Make all round borders on all negative numbers square making them a bit more of an eyesore so you want to get rid of them!"
    },
    "UnclearedAccountHighlight": {
        ...
        "description": "Add a small indicator next to account balances on the sidebar to indicate not all transactions are cleared.",
        "options": [
            {
    ...
    "ViewZeroAsEmpty": {
        ...
        "description": "If a cell is zero in the Income v. Expense report, replace it with an empty cell so it is easier to focus on non-zero cells. \"Total\" rows are not modified."
    },
    "HideDebtRatio": {
        "name": "HideDebtRatio",
        "type": "checkbox",
    ...
    "SavingsRatio": {
        ...
        "section": "toolkitReports",
        "title": "Savings Ratio",
        "description": "Display savings ratio (how much of income you do not spend) in Toolkit reports. Enable this to select target savings ratio. All values below this threshold will be painted red.",
        "options": [
            {
                "name": "5%",
                "value": "0.05"
    ...
    "ToolkitReportsURLNavigation": {
        ...
        "description": "Enable URL-based navigation for Toolkit Reports. This allows you to navigate directly to specific report tabs and share links to reports."
    }
};
...
/* harmony export */   getCurrentOrigin: () => (/* binding */ getCurrentOrigin)
/* harmony export */ });
/* harmony import */ var toolkit_app_config_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75);

const APP_CONFIG = toolkit_app_config_json__WEBPACK_IMPORTED_MODULE_0__;
const getCurrentOrigin = () => typeof window !== 'undefined' && window.location?.origin ? window.location.origin : '*';
...
/* harmony import */ var toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36);
/* harmony import */ var toolkit_core_settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49);
/* harmony import */ var toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74);
/* harmony import */ var _messages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(441);
...
function sendToolkitBootstrap(options) {
  const browser = (0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)();
  const environment = (0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getEnvironment)();
  const manifest = browser.runtime.getManifest();
  window.postMessage({
    type: _messages__WEBPACK_IMPORTED_MODULE_4__.InboundMessageType.Bootstrap,
    ynabToolKit: {
      assets: {
      ...
      links: {
        privacy: toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.privacyUrl,
        releases: toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.releasesUrl,
        support: toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.supportUrl
      },
      name: manifest.name,
      options,
      version: manifest.version
    }
  }, (0,toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.getCurrentOrigin)());
}
function toolkitMessageHandler(event) {
  ...
  if (event.data && event.data.type) {
    switch (event.data.type) {
      case _messages__WEBPACK_IMPORTED_MODULE_4__.OutboundMessageType.ToolkitLoaded:
      ...
      case 'ynab-toolkit-set-setting':
        if (event.data.setting && typeof event.data.setting.name === 'string' && toolkit_core_settings__WEBPACK_IMPORTED_MODULE_2__.allToolkitSettings.some(({
          name
        }) => name === event.data.setting.name)) {
...
function handleToolkitError(context) {
  (0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)().runtime.sendMessage({
    type: 'error',
    context
  });
}
function handleSetFeatureSetting({
  name,
  value
}) {
...
function handleFeatureSettingChanged(settingName, newValue) {
  if (settingName.startsWith(toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_1__.FEATURE_SETTING_PREFIX)) {
    window.postMessage({
      type: _messages__WEBPACK_IMPORTED_MODULE_4__.InboundMessageType.SettingChanged,
      setting: {
        name: settingName.slice(toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_1__.FEATURE_SETTING_PREFIX.length),
        value: newValue
      }
    }, (0,toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.getCurrentOrigin)());
  }
...
async function initializeYNABToolkit() {
  const userSettings = await (0,toolkit_core_settings__WEBPACK_IMPORTED_MODULE_2__.getUserSettings)();
...
async function init() {
  ...
  if (isToolkitDisabled) {
    console.log(`${(0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)().runtime.getManifest().name} is disabled!`);
    return;
  }
  if (toolkitInitiated) {
    console.log(`${(0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)().runtime.getManifest().name} is already initiated`);
    return;
  }
  console.log(`${(0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)().runtime.getManifest().name} initiated`);

  // Load the toolkit bundle onto the YNAB dom
  const script = document.createElement('script');
  script.setAttribute('type', 'text/javascript');
  script.setAttribute('src', (0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)().runtime.getURL('web-accessibles/ynab-toolkit.js'));
  ...
  toolkit_core_settings__WEBPACK_IMPORTED_MODULE_2__.allToolkitSettings.forEach(({
    name
  }) => {

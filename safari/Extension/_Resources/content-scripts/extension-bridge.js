/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 3(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
      'use strict';
    ...
    /***/ 11(module, __unused_webpack_exports, __webpack_require__) {
      module.exports =
    ...
    /***/ 74(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var toolkit_app_config_json__WEBPACK_IMPORTED_MODULE_0__ =
  ...
  (() => {
    ...
    /* harmony import */ var toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__ =
      ...
      window.postMessage(
        {
          ...
          ynabToolKit: {
            ...
            links: {
              privacy:
                toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.privacyUrl,
              releases:
                toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.releasesUrl,
              support:
                toolkit_core_common_app_config__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.supportUrl,
            },
            name: manifest.name,
            options,
        ...
        switch (event.data.type) {
          ...
          case 'ynab-toolkit-set-setting':
            if (
              ...
              toolkit_core_settings__WEBPACK_IMPORTED_MODULE_2__.allToolkitSettings.some(
                ({ name }) => name === event.data.setting.name,
              )
            ) {

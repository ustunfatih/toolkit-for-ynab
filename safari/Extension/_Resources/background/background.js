...
/* harmony export */   NEXT_UPDATE_CHECK_STORAGE_KEY: () => (/* binding */ NEXT_UPDATE_CHECK_STORAGE_KEY)
/* harmony export */ });
...
/* harmony import */ var toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35);
...
class Background {
  constructor() {
    _defineProperty(this, "_browser", (0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowser)());
    _defineProperty(this, "_storage", new toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_1__.ToolkitStorage());
    _defineProperty(this, "_handleUpdateAvailable", () => {
      this._browser.runtime.reload();
    });
    _defineProperty(this, "_checkForUpdates", async () => {
      if ((0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.getBrowserName)() !== toolkit_core_common_constants__WEBPACK_IMPORTED_MODULE_2__.Browser.Chrome) {
        return;
      }
      const now = Date.now();
  ...
  initListeners() {
    ...
    if (!(0,toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_0__.isSafariBrowser)() && this._browser.runtime?.onUpdateAvailable?.addListener) {
      this._browser.runtime.onUpdateAvailable.addListener(this._handleUpdateAvailable);
    }
    this._storage.onToolkitDisabledChanged((_, isToolkitDisabled) => this._updatePopupIcon(isToolkitDisabled));
